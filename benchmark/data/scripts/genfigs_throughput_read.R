...
filenames<-c("hashmap","natarajan","bonsai","list")
for (f in filenames){
read.csv(paste("../final/",f,"_result_read.csv",sep=""))->lindata
...
ggsave(filename = paste("../final/",f,"_linchart_throughput_read.pdf",sep=""),linchart,width=7.3, height = 5, units = "in", dpi=300)
