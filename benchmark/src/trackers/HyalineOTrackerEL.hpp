...
#ifndef HyalineOEL_TRACKER_HPP
#define HyalineOEL_TRACKER_HPP
...
template<class T> class HyalineOELTracker: public BaseTracker<T>{
private:
	int task_num;
	bool collect;
...
private:
	...
	static HyalineOELTracker *myself;
public:
	~HyalineOELTracker(){};

	HyalineOELTracker(int task_num, int epochFreq, int emptyFreq, bool collect):
...
template<class T>
HyalineOELTracker<T>* HyalineOELTracker<T>::myself;
